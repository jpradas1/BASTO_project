...
* Crear una [API](https://fastapi-basto-project.onrender.com/docs) que brinde la cantidad de días de alimento disponible a partir de parámetros ingresados por el usuario.
